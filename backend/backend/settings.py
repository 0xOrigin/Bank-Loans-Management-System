...
DATABASES = {
    'default': {
        ...
        'TIME_ZONE': env.str('DB_TIME_ZONE', default='UTC'),
        'CHARSET': env.str('DB_CHARSET', default='utf8'),
        'OPTIONS': {
            'isolation_level': psycopg2.extensions.ISOLATION_LEVEL_READ_COMMITTED if env.str(
                'DB_ENGINE', default='django.db.backends.sqlite3') != 'django.db.backends.sqlite3' else None,
        }
    }
}
